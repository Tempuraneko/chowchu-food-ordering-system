...
<?php
try {
  $stmt = $pdo->query("SELECT foodId, foodName, foodDetail, foodImage, price, foodType FROM fooddetail");
...
<section class="hero-banner" id="heroBanner">
  ...
  <section class="product-filters container">
    ...
    <input type="text" placeholder="Search by enter food name....." class="menu-search" id="menuSearch"/>
  </section>
